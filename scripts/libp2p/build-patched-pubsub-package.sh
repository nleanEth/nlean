...
PATCH_FILE="$ROOT_DIR/scripts/libp2p/patches/pubsub-anonymous.patch"
...
PACKAGE_ID="Nethermind.Libp2p.Protocols.Pubsub"
PACKAGE_VERSION="1.0.0-preview.51"
PACKAGE_FILE="$LOCAL_FEED_DIR/${PACKAGE_ID}.${PACKAGE_VERSION}.nupkg"
PACKAGE_CACHE_DIR="${NUGET_PACKAGES:-$ROOT_DIR/.nuget/packages}/nethermind.libp2p.protocols.pubsub/${PACKAGE_VERSION}"
...
dotnet pack "$WORK_DIR/src/libp2p/Libp2p.Protocols.Pubsub/Libp2p.Protocols.Pubsub.csproj" \
  -c Release \
