...
public sealed class DevnetCluster : IDisposable
{
    ...
    public DevnetCluster(int nodeCount = 4, int basePort = 19100, int validatorsPerNode = 1, int attestationCommitteeCount = 1)
    {
        _fixture = new DevnetFixture(nodeCount, basePort, validatorsPerNode, attestationCommitteeCount);
